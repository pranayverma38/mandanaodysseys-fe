...
const PayWith = () => {
  ...
  return (
    <div className="pt-5">
      <h3 className="text-2xl font-medium">Pay with</h3>
      ...
      >
        <TabList className="my-5 flex gap-1 text-sm">
          <Tab className="flex items-center gap-x-2 rounded-full px-4 py-2.5 leading-none font-medium data-hover:bg-black/5 data-[selected]:bg-foreground data-[selected]:text-background sm:px-6">
            Paypal
