...
export const FOOTER_TAGLINE = 'Explore the best trip deals in trending destinations, worldwide.'
export const FOOTER_COPYRIGHT = '© 2026 Mandana Odysseys. All rights reserved.'
...
export const footerTalkToUs: FooterLinkWithIcon[] = [
  {
    name: 'support@mandanaodysseys.com',
  ...
  },
  {
    ...
    href: '#',
    icon: (props) => <TicketIcon {...props} />,
  },
]

export const footerSocial: FooterLinkWithIcon[] = [
  {
    name: 'Facebook',
    href: '#',
    icon: (props) => (
