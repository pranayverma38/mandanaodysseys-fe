...
/** Static demo account data (Eden Smith) for /account/dummy previews. */
export const DUMMY_ACCOUNT_DATA: AccountData = {
  profile: {
    fullName: 'Eden Smith',
  ...
  wishlistPackageIds: [
    ...
    'thailand-phuket-solo-beach-escape',
  ],
}

export async function getDummyAccountData(): Promise<AccountData> {
