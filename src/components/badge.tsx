...
const colors = {
  white: 'bg-white text-neutral-700 group-data-hover:bg-white/25',
  light:
    'bg-white text-neutral-700 group-data-hover:bg-white/25 dark:bg-white/10 dark:text-neutral-400 dark:group-data-hover:bg-white/20',
