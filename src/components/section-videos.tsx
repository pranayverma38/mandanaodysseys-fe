...
const SectionVideos: FC<SectionVideosProps> = ({ videos = demo_videos, className = '' }) => {
  ...
  return (
    <div className={`nc-SectionVideos ${className}`}>
      <Heading>🎬 The Videos</Heading>

      <div className="relative flex flex-col sm:py-4 sm:pe-4 md:py-6 md:pe-6 lg:flex-row xl:py-14 xl:pe-14">
        <div className="absolute -end-4 -top-4 -bottom-4 z-0 w-2/3 rounded-3xl bg-gray-100/40 sm:rounded-[50px] md:end-0 md:top-0 md:bottom-0 xl:w-1/2 dark:bg-neutral-800/40" />
...
const PlayIconBtn = () => {
  return (
    ...
    >
      <div className="relative h-full w-full rounded-full bg-white text-primary">
