...
const NotifyDropdown: FC<Props> = ({ className = '' }) => {
  return (
    <Popover className={className}>
      <>
        <PopoverButton as={ButtonCircle} plain>
          <span className="absolute end-1.5 top-1.5 size-2 rounded-full bg-blue-500"></span>
        ...
        <PopoverPanel
          ...
          className="z-40 w-sm rounded-3xl shadow-lg-for-card bg-card transition duration-200 ease-in-out data-closed:translate-y-1 data-closed:opacity-0"
        >
