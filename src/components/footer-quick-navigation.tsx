...
const FooterQuickNavigation = () => {
  ...
  const showHideNavMenu = useCallback(() => {
    ...
    const searchPageShowMapbtnEl = document.getElementById('search-page-show-map-btn')
    ...
    if (currentScrollPos > lastScrollY.current) {
      ...
      searchPageShowMapbtnEl?.classList.add('translate-y-15')
    } else {
      ...
      searchPageShowMapbtnEl?.classList.remove('translate-y-15')
    }
