...
const styles = {
  base: [
    // Base
    'relative isolate inline-flex shrink-0 items-center justify-center gap-x-2.5 rounded-full border font-[450]',
    // Sizing
    'px-[calc(--spacing(4)-1px)] py-[calc(--spacing(2.5)-1px)] sm:px-[calc(--spacing(5)-1px)] text-base',
    // Focus
  ...
  colors: {
    ...
    primary: [
      ...
      '[--btn-icon:var(--color-primary)] data-active:[--btn-icon:var(--color-primary)] data-hover:[--btn-icon:var(--color-primary)]',
    ],
    accent: [
